...
int main()
{
    ...
    Texture t;
    t.loadFromFile("D:\\Èíôà\\10\\paints\\tiles.png");
    Sprite tiles(t);

    Texture sn;
    sn.loadFromFile("D:\\Èíôà\\10\\paints\\snake.png");
    Sprite snake(sn);

    Texture ap;
    ap.loadFromFile("D:\\Èíôà\\10\\paints\\apple.png");
    Sprite apple(ap);

    Texture go;
    go.loadFromFile("D:\\Èíôà\\10\\paints\\gameover.png");
    Sprite gameover(go);
